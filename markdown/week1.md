...
1. **Was there a call-to-action that persuaded you to continue playing the game?**  
    ...
    and my grandfather's research, I was made curious and I ended up playing the
    game longer than I expected.  
    <br>
2. **How did the game teach you its main mechanics?**  
    Through that spontaneous duel against a lamp, I was taught part of the
    combat system, where I would have to decide what action to take during each
    "turn" of the fight. I didn't understand every option available to me, but
    the menu was simplistic enough that I could stumble my way through a fight
    and learn the turn-based nature of the combat in the game. Through
    interacting with a character, I learned that my grandfather apparently knows
    something about that PSI option in the combat and interaction menus. Curious
    what that meant, I selected that option and saw a "telepathy" option.  
    The details of the game's world led me to attempt to understand more deeply 
    what options I have as a player, rooted in curiosity rather than confusion 
    when not understanding how to proceed in a situation or on a level.  
    <br>
3. **How did it guide you?**  
    Instead of guiding me through the world and instructing me, the game seemed 
    to intentially make me confused and weirdly stressed with flashing orange 
    lighting and intense music.  
    While I immediately drew visual comparisions to a game like Undertale,
    something that also has you explore its world and uncover things, I remember
    Undertale's world providing much more guidance and context initially.  
    <br>
4. **Did you get lost or confused?**  
    I was definitely confused, and most things I saw ended up leaving me with
    more questions, but I never felt lost. The game quickly helped me understand
...
5. **Did the game introduce an emotional element at the beginning to motivate the player’ s journey?**  
    ...
    explore the world.  
    <br>
6. **Can you predict your overall goal in the game from these first 5 minutes?**
  
    I genuinely have no idea. I assume it has something to do with the parental
    figures in the game, since the game opens with talking about people from the
    far past, has characters mentioning my father and grandfather, and the game
    is also known as "Mother". I can also assume I'll have to engage in more
    combat, pick up more skills since I can't perform telepathy when I try, and
    perhaps gain those skills through leveling up which happened after I
    defeated the doll. The final goal is unclear, but I'm definitely curious and
    that was enough to keep me going. It feels like that end goal is something
...
9. **How do the game visuals and audio influence the gameplay experience?**  
    ...
    after I defeated the doll, the music felt very welcoming and calming in
    comparision to that opening scene, building tension due to the contrast
